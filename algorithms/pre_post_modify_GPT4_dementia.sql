...
create or replace table llm_a_dementia_2_code as -- these tables live in default
select * from
(
...
and year(condition_start_date)<2020 -- this was added to better match the temporal window of the eMERGE implementation
