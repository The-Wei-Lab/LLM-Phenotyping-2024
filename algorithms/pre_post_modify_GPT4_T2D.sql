...
select * from jamia_llm_v1.phemap_t2d_gwas_v1; -- this table contains the GRIDs from the eMERGE phenotype implementation


create or replace table llm_a_t2d_2_code as -- these tables live in default
select distinct person_id from
(
select distinct person_id from jamia_llm_v1.phemap_t2d_gwas_v1 -- this table contains the GRIDs from the eMERGE phenotype implementation
...
and year(condition_start_date)<2020 -- this was added to match the temporal window of the eMERGE implementation
